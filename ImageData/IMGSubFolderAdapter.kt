...
class IMGSubFolderAdapter(
    private var images: List<ImageModel>,
    private val onImageSelected: (ImageModel) -> Unit
) : RecyclerView.Adapter<IMGSubFolderAdapter.ImageViewHolder>() {
...
//        holder.checkBox.visibility = if (image.isSelected) View.VISIBLE else View.GONE
