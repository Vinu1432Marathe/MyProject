...
class SecureSubFolderAdapter(private val files: List<FileModel>,
                             private val onItemSelected: (FileModel) -> Unit ) :
    RecyclerView.Adapter<SecureSubFolderAdapter.FileViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FileViewHolder, position: Int) {
        ...
        val iconRes = if (file.isSelected) R.drawable.ic_check else R.drawable.ic_unchecked
        holder.moreIcon.setImageResource(iconRes)

//        holder.moreIcon.visibility = if (file.isSelected) View.VISIBLE else View.GONE
